...
// Definir cuántos días de vacaciones totales tiene cada empleado por defecto
    ...
    <table id="tablaEmpleados" class="table table-striped table-hover">
      ...
      <tbody>
        <?php foreach ($emps as $e): ?>
          <?php
            // Calcular los días tomados y disponibles
          ...
          <tr>
            ...
            <td><?= number_format($e['salario'] * 0.0483, 2) ?></td>
            <td><?= number_format($e['salario'] * 0.01, 2) ?></td>
...
<!-- Script JS para manejar selección, editar, borrar e imprimir -->
<script>
